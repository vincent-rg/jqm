...
class JobQueue:
    ...
    def _is_job_editable(self, job: Job) -> bool:
        ...
        Note: Must be called from within a locked context.
    ...
    def _get_job_unlocked(self, job_id: int) -> Job:
        """Get a job by ID without acquiring lock.
    ...
    def _get_running_job_unlocked(self) -> Optional[Job]:
        """Get the currently running job without acquiring lock.
